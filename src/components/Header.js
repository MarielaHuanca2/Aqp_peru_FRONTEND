        ...
        <Nav className="me-auto d-flex align-items-center" style={{ width: "100%" }}>
          ...
          <div className="nav-item mega-hover mega-dropdown" style={{ position: "relative" }}>
            ...
            <div className="mega-menu">
              <div className="mega-menu-content" style={{ display: "flex", flexWrap: "nowrap", gap: "0", minWidth: "500px", alignItems: "flex-start" }}>
                {/* Tipos de producto */}
                <div style={{ minWidth: "180px", marginRight: "16px" }}>
                  <div style={{ fontWeight: 600, fontSize: "1.1rem", marginBottom: "10px", textAlign: "left" }}>Tipos de Producto</div>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                    <li><Link to="/productos/laptops" style={{ color: "#222", textDecoration: "none" }}>Laptops</Link></li>
                    <li><Link to="/productos/servidores" style={{ color: "#222", textDecoration: "none" }}>Servidores</Link></li>
                    <li><Link to="/productos/pcs" style={{ color: "#222", textDecoration: "none" }}>PCs</Link></li>
                    <li><Link to="/productos/monitores" style={{ color: "#222", textDecoration: "none" }}>Monitores</Link></li>
                    <li><Link to="/productos/impresoras" style={{ color: "#222", textDecoration: "none" }}>Impresoras</Link></li>
                    <li><Link to="/productos/accesorios" style={{ color: "#222", textDecoration: "none" }}>Accesorios</Link></li>
                  </ul>
                </div>
                {/* Separador vertical */}
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, width: "140px" }}>
                      {["DELL","Lenovo","HP","HPE","Cisco","Extreme Networks","Fortinet","Microsoft"].map((marca, idx) => (
                        <li key={idx} style={{ marginBottom: "8px" }}>
                          <Link to={`/productos/marca/${marca.toLowerCase().replace(/\s+/g, '-')}`} style={{ color: "#222", textDecoration: "none" }}>{marca}</Link>
                        </li>
                      ))}
                    </ul>
                    {/* Segunda columna */}
          ...
          <div className="nav-item mega-hover mega-dropdown" style={{ position: "relative" }}>
            ...
            <div className="mega-menu">
              <div className="mega-menu-content" style={{ flexWrap: "wrap", gap: "1.5rem" }}>
                ...
                {[
                  ...
                  <div key={idx} style={{ width: "120px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                    <img
                      src={marca.logo}
                      alt={marca.nombre}
                      style={{ height: "54px", objectFit: "contain", marginBottom: "10px", maxWidth: "100px", filter: "drop-shadow(0 2px 6px rgba(0,0,0,0.08))" }}
                    />
